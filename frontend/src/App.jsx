...
Bulduğun göstergeleri şu JSON şemasında döndür. JSON dışında hiçbir şey yazma:
{
  ...
  // n8n BIST Report Tracker States
  ...
  // n8n BIST Report Tracker Handlers
             ...
             <section className="glass-card active-border" style={{ display: "flex", flexDirection: "column", gap: "16px", maxHeight: "calc(100vh - 180px)" }}>
               <div className="flex-between">
                 ...
                 <div className="flex-gap-sm">
                   ...
                   <button className="btn btn-primary" style={{ display: "flex", gap: "6px" }} onClick={handleExportN8nExcel} disabled={n8nChecks.length === 0}>
